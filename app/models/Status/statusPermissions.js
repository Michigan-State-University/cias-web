...
const ALLOWED_INVITING_EMAIL_PARTICIPANTS = [published];
...
export const canInviteEmailParticipants = (interventionStatus) =>
  ALLOWED_INVITING_EMAIL_PARTICIPANTS.includes(interventionStatus);
