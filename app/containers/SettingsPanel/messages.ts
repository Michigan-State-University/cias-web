...
export default defineMessages({
  ...
  anyoneWithTheLinkSublabel: {
    ...
    defaultMessage:
      '<b>Anyone with the link</b> can access the intervention. Responses will be <b>anonymous</b> - therefore branching between sessions is <b>not</b> supported. Anyone with SMS Code can access SMS Campaigns.',
  },
  anyoneWhoIsARegisterdParticipantSublabel: {
    id: `${scope}.anyoneWhoIsARegisterdParticipantSublabel`,
    defaultMessage:
      'To access the intervention, participants must <b>create</b> or <b>have</b> a <b>CIAS account.</b> Anyone with SMS Code can access SMS Campaigns.',
  },
  onlyInvitedRegisteredParticipantsSublabel: {
    id: `${scope}.onlyInvitedRegisteredParticipantsSublabel`,
    defaultMessage:
      'Participants can only access the intervention <b>if access is granted</b> by entering their email address below. Participants must also <b>create</b> or <b>have</b> a <b>CIAS account.</b> Anyone with SMS Code can access SMS Campaigns.',
  },
  accessGiverHeader: {
