...
// We are rounding up to 10 kB for validation messages readability in MMSes sent outside the US
export const MMS_MAX_TEXT_SIZE = 10240;

// 4.99 kB
export const MMS_MAX_FILE_SIZE = MAX_FILE_SIZE - MMS_MAX_TEXT_SIZE;
