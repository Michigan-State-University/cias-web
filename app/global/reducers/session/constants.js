...
export const GET_SESSION_REQUEST = 'app/GET_SESSION_REQUEST';
export const GET_SESSION_SUCCESS = 'app/GET_SESSION_SUCCESS';
export const GET_SESSION_ERROR = 'app/GET_SESSION_ERROR';
