...
export const UPLOAD_TEXT_MESSAGE_ATTACHMENT_REQUEST =
  'app/TextMessages/UPLOAD_TEXT_MESSAGE_ATTACHMENT_REQUEST';
export const UPLOAD_TEXT_MESSAGE_ATTACHMENT_SUCCESS =
  'app/TextMessages/UPLOAD_TEXT_MESSAGE_ATTACHMENT_SUCCESS';
export const UPLOAD_TEXT_MESSAGE_ATTACHMENT_ERROR =
  'app/TextMessages/UPLOAD_TEXT_MESSAGE_ATTACHMENT_ERROR';

export const DELETE_TEXT_MESSAGE_ATTACHMENT_REQUEST =
  'app/TextMessages/DELETE_TEXT_MESSAGE_ATTACHMENT_REQUEST';
export const DELETE_TEXT_MESSAGE_ATTACHMENT_SUCCESS =
  'app/TextMessages/DELETE_TEXT_MESSAGE_ATTACHMENT_SUCCESS';
export const DELETE_TEXT_MESSAGE_ATTACHMENT_ERROR =
  'app/TextMessages/DELETE_TEXT_MESSAGE_ATTACHMENT_ERROR';
...
export const UPLOAD_TEXT_MESSAGE_VARIANT_ATTACHMENT_REQUEST =
  'app/TextMessages/UPLOAD_TEXT_MESSAGE_VARIANT_ATTACHMENT_REQUEST';
export const UPLOAD_TEXT_MESSAGE_VARIANT_ATTACHMENT_SUCCESS =
  'app/TextMessages/UPLOAD_TEXT_MESSAGE_VARIANT_ATTACHMENT_SUCCESS';
export const UPLOAD_TEXT_MESSAGE_VARIANT_ATTACHMENT_ERROR =
  'app/TextMessages/UPLOAD_TEXT_MESSAGE_VARIANT_ATTACHMENT_ERROR';

export const DELETE_TEXT_MESSAGE_VARIANT_ATTACHMENT_REQUEST =
  'app/TextMessages/DELETE_TEXT_MESSAGE_VARIANT_ATTACHMENT_REQUEST';
export const DELETE_TEXT_MESSAGE_VARIANT_ATTACHMENT_SUCCESS =
  'app/TextMessages/DELETE_TEXT_MESSAGE_VARIANT_ATTACHMENT_SUCCESS';
export const DELETE_TEXT_MESSAGE_VARIANT_ATTACHMENT_ERROR =
  'app/TextMessages/DELETE_TEXT_MESSAGE_VARIANT_ATTACHMENT_ERROR';
...
export const TEXT_MESSAGE_VARIANT_DEFAULT_STATE = {
  uploadAttachmentLoading: false,
  uploadAttachmentError: null,
};
